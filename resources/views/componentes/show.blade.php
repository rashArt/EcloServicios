            ...
            <div class="widget-content">
              <div class="text-center">
                @if (Auth::user()->nivel === 'tecnico')
                  ...
                  <a href="{{ URL::to('servicio/componentes/' . $servicio->id .'/edit') }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Imprimir"><i class="icon-plus"></i> Agregar Componentes</a>
                @endif
